...
-(void)setupNBBrowser{
    _nbBrowser = [[MCNearbyServiceBrowser alloc] initWithPeer:_peerID serviceType:@"chat-nb"];
...
-(void)advertiseNearBySelf:(BOOL)shouldNBAdvertise{
    if (shouldNBAdvertise) {
        _nbAdver = [[MCNearbyServiceAdvertiser alloc] initWithPeer:_peerID discoveryInfo:nil serviceType:@"chat-nb"];
